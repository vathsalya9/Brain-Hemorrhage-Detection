...
model = keras.models.load_model('2019-12-04-01_23_28.857681-08_00-ResNet50-conv+head-670k-epoch=04-valid-loss=0.06.hdf5', custom_objects={'correct_positive_diagnoses': correct_positive_diagnoses})
